...
//
//        String csvFile = "crimesample.csv";
//        String line;
//        String cvsSplitBy = ",";
//
...
//
//                LondonCrimeDetails crime = new LondonCrimeDetails(data[0], Double.parseDouble(data[1]), Double.parseDouble(data[2]), Integer.parseInt(data[3]));
//                crimes.add(crime);
//            }
//        } catch (IOException e) {
//            e.printStackTrace();
